let square_class = document.getElementsByClassName("square");
let white_checker_class = document.getElementsByClassName("white_checker");
let black_checker_class = document.getElementsByClassName("black_checker");
let table = document.getElementById("table");
let score = document.getElementById("score");
let black_background = document.getElementById("black_background");
...
let tableLimit,reverse_tableLimit ,  moveUpLeft,moveUpRight, moveDownLeft,moveDownRight , tableLimitLeft, tableLimitRight;
...
let square_p = function(square,index){
    this.id = square;
    this.ocupied = false;
...
let checker = function(piece,color,square) {
    this.id = piece;
    this.color = color;
    this.king = false;
